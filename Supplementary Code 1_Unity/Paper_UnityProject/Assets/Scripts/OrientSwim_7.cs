...
public class OrientSwim_7 : MonoBehaviour
{   
    ...
    IEnumerator Run(){
        ...
        transform.position = new Vector3(17.85f, 6.5f, 0.0f);
    ...
    void SaveVirtualFishData(){
        string csvFilePath = Date + "Data_7.csv"; // Specify the path and name of the CSV file
