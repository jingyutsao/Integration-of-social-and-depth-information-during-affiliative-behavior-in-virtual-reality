...
public class RealFishTracking_1 : MonoBehaviour {
    ...
    void Update() {
        ...
        transform.position = new Vector3(-5f, 10f,-NowZposition*1.75f+7.7f+16.2f);
        // transform.position = new Vector3((-NowXposition*1.75f), 10f,-NowZposition*1.75f+7.7f+16.2f);
