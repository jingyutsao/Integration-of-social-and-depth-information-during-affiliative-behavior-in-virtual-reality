...
public class OrientSwim_8 : MonoBehaviour
{   
    ...
    IEnumerator Run(){
        ...
        transform.position = new Vector3(17.85f, 4.0f, 0.0f);
    ...
    void SaveVirtualFishData(){
        string csvFilePath = Date + "Data_8.csv"; // Specify the path and name of the CSV file
