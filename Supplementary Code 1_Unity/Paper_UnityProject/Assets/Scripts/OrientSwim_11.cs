...
public class OrientSwim_11 : MonoBehaviour
{   
    ...
    IEnumerator Run(){
        ...
        transform.position = new Vector3(17.85f, 4.0f, 17.0f);
    ...
    void SaveVirtualFishData(){
        string csvFilePath = Date + "Data_11.csv"; // Specify the path and name of the CSV file
